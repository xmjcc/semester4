...
class StudentSurveyApp(tk.Tk):
    def __init__(self):
        ...
        frame.lb0 = ttk.Label(self, text="ICET Student Survey",font=("Arial", 16, "bold italic"))
        frame.lb0.configure(background='light green')
        frame.lb0.place(relx=0.27, rely=0.05)
        ...
        lbl.place(relx=0.0, rely=0.18)
        lbl.configure(background='light green')

        frame.txt1 = ttk.Entry(self, width=30)


        frame.txt1.insert(0, "Narendra Pershad")
        frame.txt1.place(relx=0.3, rely=0.18)
        # frame.txt1.grid(column=1, row=1)

        # lb2 = ttk.Label(self, text ='Residency')
        # # lb2 = Label(self, text="Residency:")
        # lb2.place(relx=0.0, rely=0.26)
        ...
        # # chk1.place(relx=0.5, rely=0.1, anchor='w')
